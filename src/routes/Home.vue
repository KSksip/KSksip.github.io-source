...
<template>
    <div class="py-8 cursor-default">
        <div class="md:w-200 mx-auto tracking-wide leading-10 px-5 md:px-0">
        ...
        <div class="mx-auto md:w-200  mt-12">
            <div class="border-1 dark:border-zinc-700 border-zinc-200 md:rounded-md inset-shadow-sm px-8 pt-4 pb-8 mt-2">
